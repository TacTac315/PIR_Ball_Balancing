#ifndef __Ball_Detection_sfun_h__
#define __Ball_Detection_sfun_h__
...
extern mxArray* load_Ball_Detection_optimization_info(boolean_T isRtwGen,
  boolean_T isModelRef, boolean_T isExternal);
extern void unload_Ball_Detection_optimization_info(void);
