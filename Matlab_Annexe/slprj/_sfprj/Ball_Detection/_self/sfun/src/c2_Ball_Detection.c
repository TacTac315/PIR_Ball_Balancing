...
static boolean_T c2_c_emlrt_marshallIn(SFc2_Ball_DetectionInstanceStruct
  *chartInstance, const mxArray *c2_b_isInitialized, const char_T *c2_identifier);
static boolean_T c2_d_emlrt_marshallIn(SFc2_Ball_DetectionInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static uint8_T c2_e_emlrt_marshallIn(SFc2_Ball_DetectionInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_Ball_Detection, const char_T *
  c2_identifier);
static uint8_T c2_f_emlrt_marshallIn(SFc2_Ball_DetectionInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
  ...
  (SFc2_Ball_DetectionInstanceStruct *chartInstance)
{
  ...
  c2_c_y = NULL;
  sf_mex_assign(&c2_c_y, sf_mex_create("y", chartInstance->c2_ballX_data, 6, 0U,
    1U, 0U, 1, *chartInstance->c2_ballX_sizes), false);
  sf_mex_setcell(c2_y, 1, c2_c_y);
  c2_d_y = NULL;
  sf_mex_assign(&c2_d_y, sf_mex_create("y", chartInstance->c2_ballY_data, 6, 0U,
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  int32_T c2_loop_ub;
  int32_T c2_i;
  int32_T c2_b_tmp_data[2];
  int32_T c2_b_tmp_size[1];
  int32_T c2_b_loop_ub;
  int32_T c2_i1;
  int32_T c2_c_tmp_data[2];
  ...
  *chartInstance->c2_ballY_sizes = c2_c_tmp_size[0];
  ...
  chartInstance->c2_isInitialized = c2_c_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c2_u, 3)), "isInitialized");
  chartInstance->c2_is_active_c2_Ball_Detection = c2_e_emlrt_marshallIn
  ...
  (SFc2_Ball_DetectionInstanceStruct *chartInstance)
{
  ...
  static const int32_T c2_condTxtStartIdx[1] = { 1091 };

  static const int32_T c2_condTxtEndIdx[1] = { 1105 };

  static const int32_T c2_postfixPredicateTree[2] = { 0, -1 };

  static const int32_T c2_b_condTxtStartIdx[1] = { 1465 };

  static const int32_T c2_b_condTxtEndIdx[1] = { 1483 };
  ...
  covrtEmlFcnInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U,
                     "eML_blk_kernel", 0, -1, 1631);
  covrtEmlSaturationInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U, 1500,
    -1, 1526);
  covrtEmlSaturationInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 1U, 1544,
    -1, 1570);
  covrtEmlIfInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U, 454, 471, 1087,
                    1396);
  covrtEmlIfInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 1U, 1087, 1105,
                    1264, 1396);
  covrtEmlIfInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 2U, 1461, 1483,
                    1628, 1631);
  covrtEmlWhileInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U, 399, 410,
                       1631);
  covrtEmlMCDCInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 0U, 1090, 1105,
                      1U, 0U, c2_condTxtStartIdx, c2_condTxtEndIdx, 2U,
                      c2_postfixPredicateTree);
  covrtEmlMCDCInitFcn(chartInstance->c2_covrtInstance, 4U, 0U, 1U, 1464, 1483,
  ...
  *chartInstance, const emlrtStack *c2_sp)
{
  ...
  int32_T c2_b_ballX_data[2];
  int32_T c2_ballY_size[1];
  int32_T c2_b_ballY_data[2];
  ...
  do {
    ...
    if (covrtEmlIfEval(chartInstance->c2_covrtInstance, 4U, 0, 1,
      ...
      c2_areas = c2__s32_s64_(chartInstance, (int64_T)c2_areas_size[0] *
        (int64_T)c2_areas_size[1], 0, 1U, 1246, 12);
      ...
      if (covrtEmlIfEval(chartInstance->c2_covrtInstance, 4U, 0, 2,
        ...
        for (c2_i42 = 0; c2_i42 <= c2_i_loop_ub; c2_i42++) {
          ...
          if (c2_d < 2.147483648E+9) {
            if (c2_d >= -2.147483648E+9) {
              ...
              c2_i45 = MIN_int32_T;
              sf_data_saturate_error(chartInstance->S, 1U, 1500, 26);
            }
        ...
        c2_i46 = 2;
        c2_i47 = emlrtDynamicBoundsCheckR2012b(c2_i46, 1, c2_centroids_size[1],
          &c2_d_emlrtBCI, c2_sp) - 1;
        c2_b_ballX_size[0] = c2_d_index[0];
        c2_k_loop_ub = c2_d_index[0] - 1;
        for (c2_i48 = 0; c2_i48 <= c2_k_loop_ub; c2_i48++) {
          c2_i49 = (int32_T)emlrtIntegerCheckR2012b(c2_index_data[c2_i48],
            &c2_e_emlrtDCI, c2_sp);
          c2_d1 = muDoubleScalarRound(c2_centroids_data
            [(emlrtDynamicBoundsCheckR2012b(c2_i49, 1, c2_d_centroids,
            &c2_i_emlrtBCI, c2_sp) + c2_centroids_size[0] * c2_i47) - 1]);
          c2_b_covSaturation = false;
          if (c2_d1 < 2.147483648E+9) {
            if (c2_d1 >= -2.147483648E+9) {
              c2_i51 = (int32_T)c2_d1;
            } else {
              c2_b_covSaturation = true;
              c2_i51 = MIN_int32_T;
              sf_data_saturate_error(chartInstance->S, 1U, 1544, 26);
            }
        ...
        for (c2_i50 = 0; c2_i50 <= c2_l_loop_ub; c2_i50++) {
          c2_b_ballY_data[c2_i50] = c2_c_ballX_data[c2_i50];
        }

        c2_st.site = &c2_h_emlrtRSI;
        for (c2_i52 = 0; c2_i52 < 2; c2_i52++) {
          c2_c_areas_size[c2_i52] = c2_areas_size[c2_i52];
        }

        for (c2_i53 = 0; c2_i53 < 2; c2_i53++) {
          c2_c_index_size[c2_i53] = c2_index_size[c2_i53];
        }
        ...
        c2_b_areas = c2__s32_s64_(chartInstance, (int64_T)c2_areas_size[0] *
          (int64_T)c2_areas_size[1], 0, 1U, 1591, 12);
        c2_m_loop_ub = c2_index_size[0] * c2_index_size[1] - 1;
        for (c2_i54 = 0; c2_i54 <= c2_m_loop_ub; c2_i54++) {
          c2_i55 = (int32_T)emlrtIntegerCheckR2012b(c2_index_data[c2_i54],
            &c2_f_emlrtDCI, c2_sp);
          c2_ex_data[c2_i54] = c2_areas_data[emlrtDynamicBoundsCheckR2012b
            (c2_i55, 1, c2_b_areas, &c2_j_emlrtBCI, c2_sp) - 1];
        }
        ...
        for (c2_i56 = 0; c2_i56 <= c2_n_loop_ub; c2_i56++) {
          c2_b_ballArea_data[c2_i56] = c2_ex_data[c2_i56];
        }
      ...
      c2_ballX_size[0] = 1;
      c2_b_ballX_data[0] = 297;
      c2_ballY_size[0] = 1;
      c2_b_ballY_data[0] = 199;
  ...
  *chartInstance, const mxArray *c2_b_isInitialized, const char_T *c2_identifier)
{
  ...
  c2_thisId.fParent = NULL;
  c2_thisId.bParentIsCell = false;
  c2_y = c2_d_emlrt_marshallIn(chartInstance, sf_mex_dup(c2_b_isInitialized),
    &c2_thisId);
  ...
  switch (c2_ssIdNumber) {
   case 5U:
    sf_mex_assign(&c2_mxData, sf_mex_create("mxData",
      chartInstance->c2_ballX_data, 6, 0U, 1U, 0U, 1,
      *chartInstance->c2_ballX_sizes), false);
    break;

   case 9U:
    sf_mex_assign(&c2_mxData, sf_mex_create("mxData",
      chartInstance->c2_ballY_data, 6, 0U, 1U, 0U, 1,
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_ballX_data = (int32_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 1);
  chartInstance->c2_ballX_sizes = (int32_T *)
    ssGetCurrentOutputPortDimensions_wrapper(chartInstance->S, 1);
  chartInstance->c2_ballY_data = (int32_T (*)[2])ssGetOutputPortSignal_wrapper
    (chartInstance->S, 2);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2139028414U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3084741568U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4053017681U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2142005267U);
}
...
{
  return "semoy3O6xlM9SpzqtZdf2SF";
}
...
const char* sf_c2_Ball_Detection_get_post_codegen_info(void)
{
  ...
  const char* encStrCodegen [18] = {
    "eNrtV81u00AQdkqDqKAoEkgcqASCA4gTAgkBB2ibHxEpoRUuv5eytSfxKutdsz9uwzvwJrwAb8J",
    "TIA5ckZh13DQ4ttOSApXAkuuu/c23883Mzm6cSrvr4HUe768XHOc0Ps/gveCMrmo6rkzco/eLzo",
    "10/BiNuAk3iSShckovTkJ4Bkowo6ngbd4TuTDKeyCBe4iNhNRFbIqGhlE+aBnuWT71MqBe4AbCM",
    "H8dbYm/wdkQ2SKjN5GnQSV4ugXg60AK0w9ajPTHHku9Ww/AGygTlklQoF0TWbdU1zBNIwbNPfDa",
    "XGmCHqsD31xNNNT1XqFMq1S5+0ARRowSnqs2IMqFCAOs4Xnk498No1FUFuYFROp1CEgMqkMHCaf",
    "gkOWkCj/sUE60kJSwZsjq1nDat02G/nSFD6wkIOjbugQyiATlujj/bguVNjnZYdCAHdMvZnPhnb",
    "HJf0FhF2Rh3Hp1EYMkfdjghZMmAWnuJdkaV8k0TNMQXhC55mH+FPiF1YuVo1yCeYIttCiCQSKyr",
    "bYkjTG8hWwmbNvKnLVkTDhKtpoFS9iaMZRlYczW8nidMKYKYVsi6kAMLGFtEE3KYSPWfJxS1N8S",
    "GGBb3sWrwXCKiU9hdcF9mpuuOANI+s5TbCw/Iz2jtAjrWLyNTmf68zSszTXIHvEgrwtIQhVgzJL",
    "wFrP5VNncIxC90ol7eeBRhcxCOapneGNXyAHGpKSJHEiwGS0EhqqPucSV8FzhoimD2VzOwnnEC8",
    "C3DYYy6OKyQWxOTJRtbWu47mKqhw1QnqRRXlbt/nPbOdh/zh1i/9m3yz5vTvBUcniciWd23qWF8",
    "nkX8L9Karc6YbecmWcxY2dxNbwf3iLXv3w6Gw6/3f0Qf/94f575a9Wj7dfn0/HKfmMcF3o8VV8W",
    "+2TCr8Uc/ksT/LV0rCAUw7sb9/ZY94EbvX+n3/i9O24r4Xu7WO5vNePv/vurtkMPo6TfKum1/fQ",
    "gYcfEjLZXy39/wt/TM+KxlL4fXV8fz2e/spq1z4vXmUy87HgHV+wa7p6T9fv3dFw8lI5qRkc11f",
    "Eqsw7/no5rc+l4fWw6aqvz2U/3mTwdyxkdy8n5qM1xYyGMvk/OM8ej5+qx6NmcoedyRs/lRM82s",
    "bsIbHt3ttcxSdsN0JCc56b6/6/206PaOf/tToRd5R/Ud5jz0a/anZrzPPan7ObVd9Rz4knD3y7p",
    "o04GXzvBOuY9v/9u/GfnaOfsK+n40finbz2gzM/5FZR+7gDp5X39A/p+AEpSrNE=",
    ""
  };
...
static void mdlSetWorkWidths_c2_Ball_Detection(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(593570362U));
  ssSetChecksum1(S,(1829485038U));
  ssSetChecksum2(S,(2368992377U));
  ssSetChecksum3(S,(950861174U));
}
