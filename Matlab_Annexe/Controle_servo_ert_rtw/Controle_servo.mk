###########################################################################
## Makefile generated for Simulink model 'Controle_servo'. 
## 
## Makefile     : Controle_servo.mk
## Generated on : Mon Mar 06 13:16:37 2023
## MATLAB Coder version: 5.0 (R2020a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Controle_servo.elf
...
PRODUCT_NAME              = Controle_servo
MAKEFILE                  = Controle_servo.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2020a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2020a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/vince/OneDrive/PIR_development/PIR_Ball_Balancing/Matlab_Annexe
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Controle_servo.elf
...
DEFINES_STANDARD = -DMODEL=Controle_servo -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_ServoWriteRead.o Controle_servo.o Controle_servo_data.o updown.o ext_work.o rtiostream_utils.o MW_ArduinoHWInit.o io_wrappers.o MW_PWMDriver.o arduinoAVRScheduler.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/Controle_servo_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Controle_servo_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Controle_servo_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Controle_servo.o : $(START_DIR)/Controle_servo_ert_rtw/Controle_servo.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Controle_servo_data.o : $(START_DIR)/Controle_servo_ert_rtw/Controle_servo_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/Controle_servo_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
